Kongoh <- function(){
  ...
  Amp.mat <- matrix(c("Marker", IDloci, 
                      "Variance", 34.4, 36.7, 37.8, 35.0, 27.5, 29.4, 28.2, 32.4, 26.8, 26.8, 26.5, 29.7, 33.4, 30.2, 28.8, 
                      "Mean", 0.0490, -0.142, -0.396, -0.154, 0.235, 0.337, 0.268, 0.198, 0.0839, -0.139, -0.0160, -0.144, -0.194, -0.193, -0.265
                      ), nrow = 16, ncol = 3
                    )
  ...
  SR.mat <- matrix(c("Marker", IDloci, 
                     "Param1", 15.1, 11.0, 16.8, 17.6, 25.2, 258, 48.6, 23.9, 14.7, 29.3, 23.6, 78.7, 21.8, 33.8, 53.4, 
  ...
  LR.finish <- tclVar("0")
  Plot.finish <- tclVar("0")
  Weight.MRd.finish <- tclVar("0")
  ...
  TAB6 <- function(LRHplist = NULL, LRHdlist = NULL, Kgtmat = NULL, HpKCID = NULL, HdKCID = NULL, Hp.var.list = NULL, Hd.var.list = NULL, PGresult = NULL, BestMRdpos = NULL){
      ...
      if(paste(tclvalue(LR.finish)) == "0"){
        ...
        Report.make <- function(){
          ...
          if(tclvalue(Save.as) != ""){
            ...
            write.table(paste("Crime stain profile : ", tclvalue(CSP.var), sep = ""), file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(paste("Reference profile : ", tclvalue(Ref.var), sep = ""), file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(paste("Allele frequencies : ", tclvalue(AF.var), sep = ""), file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table("", file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)

            write.table("======== Parameters ========", file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(paste("Analytical Threshold : ", tclvalue(ATvar), sep = ""), file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(paste("Number of Monte Carlo simulation : ", tclvalue(MCvar), sep = ""), file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(paste("Minimum allele frequency : ", tclvalue(MAF.var), sep = ""), file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(paste("Theta value : ", tclvalue(Theta.var), sep = ""), file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table("Thresholds to exclude genotype combination", file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(paste("  - Stutter filter : ", tclvalue(SFvar), sep = ""), file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(paste("  - Maximum stutter peak height : ", tclvalue(Max.sph.var), sep = ""), file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(paste("  - Heterozygote balance : ", tclvalue(Hbf.var), sep = ""), file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table("", file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            ...
            write.table(paste("Prosecutor hypothesis (Hp) : ", KCname.Hp, " (+ unknown contributors)", sep = ""), file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            KCname.Hd <- paste(KCname[which(as.numeric(sapply(Hd.var.list, tclvalue)) == 1)], collapse = " + ")
            write.table(paste("Defense hypothesis (Hd) : ", KCname.Hd, " (+ unknown contributors)", sep = ""), file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table("", file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)

            write.table("======== Likelihoods in Hp ========", file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(Colname.mat_Hp, file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(Hpmat, file = ReportName, sep = ",", row.names = TRUE, col.names = FALSE, append = TRUE)

            write.table("---- Estimated Mixture Ratio ----", file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(MRmat.Hp, file = ReportName, sep = ",", row.names = FALSE, col.names = TRUE, append = TRUE)

            write.table("---- Estimated Degradation Parameters ----", file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(Colname.mat_Hp, file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(Degmat.Hp, file = ReportName, sep = ",", row.names = TRUE, col.names = FALSE, append = TRUE)
            write.table("", file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)

            write.table("======== Likelihoods in Hd ========", file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(Colname.mat_Hd, file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(Hdmat, file = ReportName, sep = ",", row.names = TRUE, col.names = FALSE, append = TRUE)

            write.table("---- Estimated Mixture Ratio ----", file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(MRmat.Hd, file = ReportName, sep = ",", row.names = FALSE, col.names = TRUE, append = TRUE)

            write.table("---- Estimated Degradation Parameters ----", file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(Colname.mat_Hd, file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(Degmat.Hd, file = ReportName, sep = ",", row.names = TRUE, col.names = FALSE, append = TRUE)
            write.table("", file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)

            write.table("======== Likelihood ratio (Hp/Hd) ========", file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(LRnamemat, file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(LRmat, file = ReportName, sep = ",", row.names = TRUE, col.names = FALSE, append = TRUE)

            write.table("---- Maximum Likelihood in Hp ----", file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(matrix(c(HpLs[HpLmaxpos], paste("(", Colname.mat_Hp[1, HpLmaxpos + 1], " contribution)"), sep = ""), 1, 2), file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table("---- Maximum Likelihood in Hd ----", file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(matrix(c(HdLs[HdLmaxpos], paste("(", Colname.mat_Hd[1, HdLmaxpos + 1], " contribution)"), sep = ""), 1, 2), file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table("---- Ratio of Maximum Likelihoods ----", file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
            write.table(matrix(HpLs[HpLmaxpos] / HdLs[HdLmaxpos], 1, 1), file = ReportName, sep = ",", row.names = FALSE, col.names = FALSE, append = TRUE)
          }
        }
        OutputPG <- function(PGresult, BestMRdpos){
          for(i in 1:length(PGresult)){
            Hgtlist <- PGresult[[i]][[2]]
            Prodlist <- PGresult[[i]][[3]]
            BestMRd <- PGresult[[i]][[5]][BestMRdpos[i], ]
            for(j in 1:length(Hgtlist)){
              PGmat <- cbind(Hgtlist[[j]], Prodlist[[j]][, BestMRdpos[i]])
              PGmat <- PGmat[order(PGmat[, ncol(PGmat)], decreasing = TRUE), , drop = FALSE]
              HNC <- (ncol(PGmat) - 1) / 2
              Hgtmat <- PGmat[, 1:(2 * HNC)]
              Hgtmat[which(Hgtmat == 99, arr.ind = TRUE)] <- "Q"
              PGmat[, 1:(2 * HNC)] <- Hgtmat
              PGnames <- rep(0, 2 * HNC + 1)
              for(k in 1:HNC){
                PGnames[c(2 * k - 1, 2 * k)] <- paste("U", k, " (", BestMRd[k], ")", sep = "")
              }
              PGnames[length(PGnames)] <- "Density"
              colnames(PGmat) <- PGnames
              write.csv(PGmat, paste("PG_", HNC, "-unknowns_", IDloci[j], ".csv", sep = ""), row.names = FALSE)
            }
          }
        }
        frame6_4 <- tkframe(frame6)
        Report.butt <- tkbutton(frame6_4, text = "    Report   ", cursor = "hand2", command = function() Report.make())
        OutputPG.butt <- tkbutton(frame6_4, text = "    Output weights    ", cursor = "hand2", command = function() OutputPG(PGresult, BestMRdpos))
        tkgrid(Report.butt, OutputPG.butt, padx = 10, pady = 10)
  ...
  TAB4 <- function(){
    ...
    frame5 <<- tkframe(tab4)
    if(paste(tclvalue(CSP.var)) == ""){
      tkgrid(tklabel(frame5, text = "        Load Crime Stain Profile!        "), pady = 10, sticky = "w")
    }
    if(paste(tclvalue(Ref.var)) == ""){
      tkgrid(tklabel(frame5, text = "        Load Reference Profile!        "), pady = 10, sticky = "w")
    }
    if(paste(tclvalue(AF.var)) == ""){
      tkgrid(tklabel(frame5, text = "        Load Allele Frequencies!        "), pady = 10, sticky = "w")
    }
    if(all(c(paste(tclvalue(CSP.var)), paste(tclvalue(Ref.var)), paste(tclvalue(AF.var))) != "")){
      LRcalc <- function(Hp.var.list, Hd.var.list){
          ...
          Likelihood.calc <- function(OPlist, Hgtlist, Prodlist, Freqlist, MRrefine, alist, cplist, Qfreqvec, MAF, theta, Kgtmat = NULL, Kgtmat2 = NULL, NPG, PGID){
            NL <- length(Hgtlist)
            NMR <- ncol(Prodlist[[1]])
            ...
            if(length(Kgtmat) != 0){
              NKC <- (ncol(Kgtmat) / 2)
              if(HNC < NKC){
                return(list(rep(0, NL), 0, 0, 0, HNC, 0))
              }else{
                ...
                for(i in 1:NKQID){
                  ...
                  for(j in 1:NL){
                    ...
                    rect(0, 0.4, (NKQID * NL * (PGID - 1) + (NL * (i - 1) + j)) * 100 / (NKQID * NL * NPG), 0.75, col = "greenyellow")
                  }
                ...
                if(prod(Likelihood_perL) > 0){
                  return(list(Likelihood_perL, prod(Likelihood_perL), KQIDs[Maxpos[1], ], MRrefine[Maxpos[2], , drop = FALSE], HNC, Maxpos[2]))
                }else{
                  return(list(Likelihood_perL, prod(Likelihood_perL), KQIDs[Maxpos[1], ], 0, HNC, Maxpos[2]))
                }
              }
            }else{
              ...
              for(i in 1:NL){
                ...
                rect(0, 0.4, (NL * (PGID - 1) + i) * 100 / (NL * NPG), 0.75, col = "greenyellow")
              }
              ...
              if(prod(Likelihood_perL) > 0){
                return(list(Likelihood_perL, prod(Likelihood_perL), 0, MRrefine[Maxpos, , drop = FALSE], HNC, Maxpos))
              }else{
                return(list(Likelihood_perL, prod(Likelihood_perL), 0, 0, HNC, Maxpos))
              }
            }
          }
          ...
          Lists.make <- function(OPHdata, Kgtmat, aList, cpList, MAF, HNC, St.filter, StPH.T, Hb.T, LOD){
            OPlist <- OHlist <- OBlist <- Hgtlist <- Freqlist <- list()
            ...
            for(i in 1:NL){
              ...
              OHcutA <- OH[which(OH != 0)] / exp(Param.A[i, 2])
              TBperL[i] <- sum(OH * OB)
              OH.correct[1, i] <- sum(OHcutA)
              if(OH.correct[1, i] > 0){
                OH.correct[2, i] <- TBperL[i] / sum(OHcutA)
              }else{
                OH.correct[2, i] <- mean(JP.ID.bList[[i]])
              }
            ...
            OHs <- unlist(OHlist)
            return(list(OPlist, OBlist, OHlist, OH.correct, Hgtlist, sum(TBperL) / sum(OHs), sum(OHs), Freqlist, Qfreqvec))
          }
          ...
          Gamma.param.estimate <- function(EPH){
            ...
            for(i in 1:ncol(EPH)){
              ...
              EPHrm0 <- EPHrm0[which(EPHrm0 <= 10000)]
              Mean <- mean(EPHrm0)
              Variance <- var(EPHrm0)
              GPmat[1, i] <- Mean^2 / Variance
              GPmat[2, i] <- Variance / Mean
            }
            return(GPmat)
          }
          ...
          Products.calc <- function(OPHdata, Kgtmat, NRV, HNC, St.filter, StPH.T, Hb.T, LOD, aList, cpList, MAF, Cutpos.T){
            ...
            NBpos <- NCto - HNC + 3
            arrows(-3, NBpos, 0, NBpos, length = 0.1, col = "red", xpd = TRUE)
            if(any(is.element(sapply(Hgtlist, length), 0))){
              Sys.sleep(3)
              cat(paste(HNC, "-person contribution is impossible!", sep = ""), "\n")
              rect(0, 0.4 + NBpos - 1, 100, 0.75 + NBpos - 1, col = "greenyellow")
              par(xpd = TRUE)
              polygon(c(-5, 0.2, 0.2, -5), c(NBpos + 0.2, NBpos + 0.2, NBpos - 0.2, NBpos - 0.2), col = "white", lty = 0)
              segments(-2, NBpos - 0.1, -2.75, NBpos, col = "green", lwd = 2)
              segments(-2, NBpos - 0.1, -0.75, NBpos + 0.1, col = "green", lwd = 2)
              par(xpd = FALSE)
              return(0)
            }else{
              ...
              MLE.degparam <- function(d){
                sum((exp(d * Lists[[4]][2, ]) / exp(d * Mmean) * Lists[[7]] / NL - Lists[[4]][1, ])^2)
              }
              ...
              for(i in 1:NL){
                ...
                if(length(alone.Q) > 0){
                  QOP <- alone.Q[which(cplone[Qpos] == max(cplone[Qpos]))[1]]
                  OP2 <- c(OP, QOP)
                ...
                MCsimu <- function(){
                  Amp <- rlnorm(Posbase1, meanlog = rep(Param.A[LID, 2], Posbase1), sdlog = sqrt(Param.A[LID, 1] / rep(TMRd, NRV)))
                ...
                EPH <- MCsimu()
                Gamma.param.mat <- Gamma.param.estimate(EPH)
                ...
                OEcomparison <- function(comb.ID){
                  ...
                  for(k in 1:Ncut){
                    ...
                    for(l in 1:NEP){
                      ...
                      if(OH3[l] == 0){
                        Prob[l] <- sum(dgamma(1:(LOD - 1), shape = Shape, scale = Scale))
                      }else{
                ...
                rect(0, 0.4 + NBpos - 1, i * 100 / NL, 0.75 + NBpos - 1, col = "greenyellow")
              }
        ...
        if(paste(tclvalue(Weight.finish)) == 0){
          ...
          if(!setequal(Llabel.CSP, Llabel.Ref)){
            ...
            if((NCfrom >= 5) || (NCto >= 5)){
              ...
              NCyesno2 <- tkmessageBox(message = "Calculation of 4-person contribution is time consuming. Do you continue the weight calculation?", icon = "question", type = "yesno")
            ...
            plot(c(0, 100), c(0, NCto - NCfrom + 4), type = "n", xlab = "", ylab = "", axes = FALSE, mar = c(3, 3, 3, 3))
            par(xpd = TRUE)
            text(50, NCto - NCfrom + 4.2, "Progress Bar", cex = 1.25)
            text(12, NCto - NCfrom + 3.5, "Weight calculation", col = "blue")
            arrows(-5.5, NCto - NCfrom + 3.5, -2.5, NCto - NCfrom + 3.5, length = 0.1, col = "red", xpd = TRUE)
            par(xpd = FALSE)
            for(i in NCfrom:NCto){
              NBpos <- NCto - i + 3
              rect(0, 0.4 + NBpos - 1, 100, 0.75 + NBpos - 1, col = "white")
              text(25, NBpos, paste("Hypothesis : ", i, "-person contribution", sep = ""))
            }
            text(15, 1.2, "Likelihood calculation", col = "blue")
            rect(0, 0.4, 100, 0.75, col = "white")
            for(i in NCfrom:NCto){
              t <- proc.time()
            ...
            par(xpd = TRUE)
            polygon(c(-7.5, -0.05, -0.05, -7.5), c(NCto - NCfrom + 3.7, NCto - NCfrom + 3.7, NCto - NCfrom + 3.3, NCto - NCfrom + 3.3), col = "white", lty = 0)
            segments(-4.5, NCto - NCfrom + 3.4, -5.25, NCto - NCfrom + 3.5, col = "green", lwd = 2)
            segments(-4.5, NCto - NCfrom + 3.4, -3.25, NCto - NCfrom + 3.6, col = "green", lwd = 2)
            par(xpd = FALSE)
          }
        }else{
          plot(c(0, 100), c(0, NCto - NCfrom + 4), type = "n", xlab = "", ylab = "", axes = FALSE, mar = c(3, 3, 3, 3))
        ...
        arrows(-5.5, 1.2, -2.5, 1.2, length = 0.1, col = "red", xpd = TRUE)
        ...
        if(as.numeric(tclvalue(Weight.MRd.finish)) == 0){
          NPG <- length(PGresults) * 3
          LRUslist <<- list()
          BestMRdpos <<- rep(0, length(PGresults))
          for(i in 1:length(PGresults)){
            LRUslist[[i]] <<- Likelihood.calc(PGresults[[i]][[1]], PGresults[[i]][[2]], PGresults[[i]][[3]], PGresults[[i]][[4]], PGresults[[i]][[5]], aList, cpList, PGresults[[i]][[6]], as.numeric(tclvalue(MAF.var)), as.numeric(tclvalue(Theta.var)), NULL, Kgtmat[, Kgt2pos], NPG, i)
            BestMRdpos[i] <<- LRUslist[[i]][[6]]
          }
        }else{
          NPG <- length(PGresults) * 2
        }
        ...
        if(length(HpKCID) != 0){
          ...
          for(i in 1:length(PGresults)){
            LRHplist[[i]] <- Likelihood.calc(PGresults[[i]][[1]], PGresults[[i]][[2]], PGresults[[i]][[3]], PGresults[[i]][[4]], PGresults[[i]][[5]], aList, cpList, PGresults[[i]][[6]], as.numeric(tclvalue(MAF.var)), as.numeric(tclvalue(Theta.var)), Kgtmat[, Kgtpos], Kgtmat[, Kgt2pos], NPG, i + length(PGresults) * (1 - as.numeric(tclvalue(Weight.MRd.finish))))
          }
          LRHplist <- LRHplist[which(sapply(LRHplist, length) != 0)]
        }else{
          LRHplist <- LRUslist
          rect(0, 0.4, 50, 0.75, col = "greenyellow")
        }
        LRHdlist <- list()
        if(length(HdKCID) != 0){
          Kgtpos <- sort(c(2 * HdKCID - 1, 2 * HdKCID))
          for(i in 1:length(PGresults)){
            LRHdlist[[i]] <- Likelihood.calc(PGresults[[i]][[1]], PGresults[[i]][[2]], PGresults[[i]][[3]], PGresults[[i]][[4]], PGresults[[i]][[5]], aList, cpList, PGresults[[i]][[6]], as.numeric(tclvalue(MAF.var)), as.numeric(tclvalue(Theta.var)), Kgtmat[, Kgtpos], Kgtmat[, Kgt2pos], NPG, i + length(PGresults) * (2 - as.numeric(tclvalue(Weight.MRd.finish))))
          }
          LRHdlist <- LRHdlist[which(sapply(LRHdlist, length) != 0)]
        }else{
          LRHdlist <- LRUslist
          rect(0, 0.4, 100, 0.75, col = "greenyellow")
        }

        par(xpd = TRUE)
        polygon(c(-7.5, -0.05, -0.05, -7.5), c(1.4, 1.4, 1, 1), col = "white", lty = 0)
        segments(-4.5, 1.1, -5.25, 1.2, col = "green", lwd = 2)
        segments(-4.5, 1.1, -3.25, 1.3, col = "green", lwd = 2)
        par(xpd = FALSE)

        Sys.sleep(3)
        tclvalue(LR.finish) <- "1"
        tclvalue(Weight.MRd.finish) <- "1"
        TAB3()
        TAB6(LRHplist, LRHdlist, Kgtmat, HpKCID, HdKCID, Hp.var.list, Hd.var.list, PGresults, BestMRdpos)
      ...
      LRcalc.butt <- tkbutton(frame5_3, text = "    Calculate   ", 
                              cursor = "hand2", command = function() LRcalc(Hp.var.list, Hd.var.list))
      tkgrid(Hp.label)
      tkgrid(Hd.label)
      ...
      tkgrid(LRcalc.butt)
      tkgrid(frame5_1, frame5_2, padx = 20)
      tkgrid(frame5_3, pady = 20)
    }
    tkgrid(frame5)
  }
  ...
  TAB3 <- function(){
    ...
    tkdestroy(frame3)
    frame3 <<- tkframe(tab3)
    if(as.numeric(tclvalue(Weight.finish)) == 1){
      tkgrid(tkbutton(frame3, text = "    Delete calculation results    ", cursor = "hand2", command = function() DeleteResult()), pady = 10, sticky = "w")
    }else{
      NClab1 <- tklabel(frame3, text = "        Set the range of assumed contributor numbers (1 - 4 contributors)")
      NC1.spinbox <- tkspinbox(frame3, from = 1, to = 4, increment = 1, textvariable = NC.Var1, width = 6, highlightthickness = 1, justify = "center", background = "white")
      NClab2 <- tklabel(frame3, text = "        ~        ")
      NC2.spinbox <- tkspinbox(frame3, from = 1, to = 4, increment = 1, textvariable = NC.Var2, width = 6, highlightthickness = 1, justify = "center", background = "white")
      ...
      MClab <- tklabel(frame3, text = "        Number of Monte Carlo simulations        ")
      ...
      tkgrid(NClab1, tklabel(frame3, text = "     "), NC1.spinbox, NClab2, NC2.spinbox, pady = 10, sticky = "w")
      tkgrid(ATlab, tklabel(frame3, text = "     "), tklabel(frame3, text = ""), ATentry, tklabel(frame3, text = ""), pady = 10, sticky = "w")
      tkgrid(MClab, tklabel(frame3, text = "     "), tklabel(frame3, text = ""), MCentry, tklabel(frame3, text = ""), pady = 10, sticky = "w")
      tkgrid(MAF.lab, tklabel(frame3, text = "     "), tklabel(frame3, text = ""), MAF.entry, tklabel(frame3, text = ""), pady = 10, sticky = "w")
      tkgrid(Theta.lab, tklabel(frame3, text = "     "), tklabel(frame3, text = ""), Theta.entry, tklabel(frame3, text = ""), pady = 10, sticky = "w")
      tkgrid(tklabel(frame3, text = ""), pady = 10, sticky = "w")
      tkgrid(Exclude.gc.lab, pady = 10, sticky = "w")
      tkgrid(Stutter.filter.lab, tklabel(frame3, text = "     "), tklabel(frame3, text = ""), Stutter.filter.entry, tklabel(frame3, text = ""), pady = 10, sticky = "w")
      tkgrid(Max.sph.lab, tklabel(frame3, text = "     "), tklabel(frame3, text = ""), Max.sph.entry, tklabel(frame3, text = ""), pady = 10, sticky = "w")
      tkgrid(Hb.filter.lab, tklabel(frame3, text = "     "), tklabel(frame3, text = ""), Hb.filter.entry, tklabel(frame3, text = ""), pady = 10, sticky = "w")
    }
    tkgrid(frame3)
  }
  ...
  EPG.view <- function(){
    if(paste(tclvalue(CSP.var)) == ""){
      ...
      if(!setequal(Marker, IDloci)){
        ...
        if(tclvalue(Save.as) != ""){
          if(substr(tclvalue(Save.as), nchar(tclvalue(Save.as)) - 3, nchar(tclvalue(Save.as))) == ".pdf"){
            ReportName <- tclvalue(Save.as)
          }else{
            ReportName <- paste(tclvalue(Save.as), ".pdf", sep = "")
          }
  ...
  Tabs <- tk2notebook(tf, tabs = c("Files", "Calculation", "Results", "Settings"))
  tkpack(Tabs, fill = "both", expand = 1)
  tab1 <- tk2notetab(Tabs, "Files")
  tab3 <- tk2notetab(Tabs, "Settings")
  tab4 <- tk2notetab(Tabs, "Calculation")
  tab6 <- tk2notetab(Tabs, "Results")
